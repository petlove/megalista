...
class BigQueryDataSource(BaseDataSource):
    ...
    def _retrieve_data_transactional(self, executions: ExecutionsGroupedBySource) -> List[DataRowsGroupedBySource]:
        ...
        if 'ADS_ENHANCED_CONVERSION_LEADS' in str(self._destination_type) and len(executions.destinations[0].destination_metadata[2]) >= 3:
            conversion_name = executions.destinations[0].destination_metadata[2]    
